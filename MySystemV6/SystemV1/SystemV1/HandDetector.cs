...
namespace SystemV1
{
    ...
    { 
        ...
        {   
            ...
            if (frame != null)
            {
                System.Drawing.Rectangle[] hands = haar.DetectMultiScale(frame, 1.03, 3, new System.Drawing.Size(frame.Width / 8, frame.Height / 8), new System.Drawing.Size(frame.Width / 3, frame.Height / 3));

                /*foreach (System.Drawing.Rectangle roi in hands)
                {
                    roi.Inflate(-5, 20);                 // Make the roi bigger, becuse we dont obteined the tootal length of the fingers, in some cases. 
                    frame.Draw(roi, new Gray (255), 3);
                }*/

                for (int i = 0; i < hands.Length; i++)
                {
                    hands[i].Inflate(-15, 20);
